...
Слишком длинных нот (duration+): {duration_long}
Слишком коротких нот (duration-): {duration_short}
...
2. В feedback для wrong_parts:
   ...
   - Для ошибок skipped описывай какую ноту пропустил или какая нота была лишней
3. Для каждого такта нужно описывать все ошибки
